...
This is the first version of `silx` supporting `PyQt6` (for `Qt6`). Please note that `PyQt6` >= v6.3.0 is required.
...
* `silx.gui`:
  ...
  * `silx.gui.hdf5`:
    * Fixed issue with unsupported hdf5 entity (e.g. datatype) (PR #3643)

  * `silx.gui.plot`:
    * `silx.gui.plot.items`:
      * Added `BandROI` item (PR #3680, #3702)
  ...
  * `silx.gui.widgets.ElidedLabel`: Fixed API inherited from `QLabel` (PR #3650)
