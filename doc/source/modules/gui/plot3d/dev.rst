...
and toolbars: :class:`ViewpointToolBar` :class:`Plot3DInteractiveModeToolBar` and :class:`Plot3DOutputToolBar`.
:class:`QAction` that can be associated with a :class:`Plot3DWidget` are defined in the :mod:`.actions` module.
Those actions are used by the :class:`Plot3DOutputToolBar` and the :class:`Plot3DInteractiveModeToolBar` toolbars.
